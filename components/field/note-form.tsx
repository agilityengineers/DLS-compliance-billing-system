...
// Auto-saves to encrypted IndexedDB; the draft is purged once the server
// acknowledges the note (sync engine); the submission itself goes through
...
export function NoteForm({
  ...
  async function submit() {
    ...
    // The draft stays until the server ACKNOWLEDGES the note: the sync engine
    // deletes `note:<visitId>` on success. Deleting it here would leave a
    // failed sync with no recoverable copy on the device (review #15).
