...
// against a real PostgreSQL (pglite, in-process).
//
...
const MIGRATION = join(import.meta.dirname, "..", "migrations", "0001_credentialing.sql");

let db: PGlite;
const exec = async (sql: string, params: unknown[]) => db.query(sql, params);
